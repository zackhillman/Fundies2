...
class ExamplesShapes {
    ...
    IShape bg = new Rect(0, 0, 5, 5);
    IShape carLong = new Rect(0, 0, 5, 1);
    IShape carTall = new Rect(0, 0, 3, 2);
    IShape wheelFront = new Circle(0, 0, 1);
    IShape wheelBack = new Circle(0, 0, 1);
